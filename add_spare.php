...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add Spare</h1>
        </div>
    </div><!--/.row-->
    <div class="col-md-12">
        <div class="panel panel-default ">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">New Spare Form</div>
                <div class="panel-body">
                    <div class="col-md-6">
                        <form action="insert_spare.php" role="form">
                            <div class="form-group">
                                <label>Item Name</label>
                                <input type="text" name="spare_name" class="form-control" placeholder="Item Name">
                            </div>
                            <div class="form-group">
                                <label>Make</label>
                            ...
                            <div class="form-group">
                                <label>Units</label>
                                <input  type="text" name="no"class="form-control" placeholder="Units">
                            </div>
