                    ...
                    <table class="table">
                        ...
                        { ?>
                            ...
                            <tr>
                                ...
                                <th scope="row"><?php echo $row['f_name'];?></th>
                                <td><?php echo $row['l_name'];?></td>
                                <td><?php echo $row['mobile_no'];?></td>
                                <td><?php echo $row['email'];?></td>
                                <td><?php echo $row['intercome'];?></td>
                                <td><form action="del_user.php" method="post">
                                        <button type="submit" class="btn btn-danger" name="submit" value="<?php echo $row['f_name'];?>">Delete User</button>
                                    </form></td>
                            </tr>
