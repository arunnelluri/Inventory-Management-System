...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">View Spare</h1>
        </div>
    </div><!--/.row-->
    <div class="col-md-12">
        <div class="panel panel-default ">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">List of Spares</div>
                <div class="panel-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="row"><?php echo $row['spare_name'];?></th>
                            <td><?php echo $row['make'];?></td>
                            <td><?php echo $row['model'];?></td>
                            <td><?php echo $row['no'];?></td>
                            <td><form action="del_spare.php" method="post">
                                    <button type="submit" class="btn btn-danger" name="submit" value="<?php echo $row['spare_name'];?>">Delete</button>
                                </form></td>
                        </tr>
